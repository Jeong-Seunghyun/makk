...
<body>
	<div class="nav">
	  ...
	  <div class="nav-header">
	    <div class="nav-title">
	      <a href="/"><img alt="logo" src="../../resources/img/whitelogo.PNG" style="width:180px;"></a>
	    </div>
	  </div>
	  <div class="loginbtn">
		...
		<sec:authorize access="isAuthenticated()">
	  	<span style="color:black; padding-top:5px;">${user.username}님&nbsp;&nbsp;</span>
	  			<a href="javascript:logoutConfirm(logoutAction);" onclick=>로그아웃</a>
